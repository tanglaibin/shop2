...
<HTML>
	<HEAD>
		...
		<script type="text/javascript">
			function addProduct(){
				window.location.href = "${pageContext.request.contextPath}/adminProduct?method=addpui";
			}
		</script>
	</HEAD>
	<body>
							...
							<table cellspacing="0" cellpadding="1" rules="all"
								...
								<c:forEach items="${list }" var="p" varStatus="vs">
										<tr onmouseover="this.style.backgroundColor = 'white'"
											...
											<td align="center" style="HEIGHT: 22px">
												<a href="${ pageContext.request.contextPath }/adminProduct?method=deletep&pid=${p.pid}">
